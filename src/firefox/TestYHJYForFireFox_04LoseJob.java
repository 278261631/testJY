...
public class TestYHJYForFireFox_04LoseJob  {
...
//    	webDriverFF.login("developer", "superxjjy903");
        ...
        addLoseJob(webDriverFF.getWebDriver());
...
//        driver.quit();
	...
	public static WebDriver addLoseJob(WebDriver driver) throws IOException, InterruptedException {
		//获取配置数据
