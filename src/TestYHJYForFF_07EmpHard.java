...
public class TestYHJYForFF_07EmpHard  {
...
//        WebElement elementSub = driver.findElement(By.linkText("登录"));
 ...
 //等待menu加载完毕二级菜单
        ...
        webWaiter.until(new ExpectedCondition<Boolean>(){
        	public Boolean apply(WebDriver d){
        		boolean loadcomplete = d.findElement(By.id("ycc131_003_radioDiv")).isDisplayed()||
        				d.findElement(By.id("ycc131_004_radioDiv")).isDisplayed()||
        				d.findElement(By.id("ycc131_005_radioDiv")).isDisplayed()||
        				d.findElement(By.id("ycc131_006_radioDiv")).isDisplayed()||
        				d.findElement(By.id("ycc131_040_radioDiv")).isDisplayed()||
        				d.findElement(By.id("ycc131_060_radioDiv")).isDisplayed()||
        				d.findElement(By.id("redirectURL")).isDisplayed()
        				;
        		return loadcomplete;
        	}
        });
        ...
        for (int i = 0; i < 6; i++) {
        	if (driver.findElement(By.id("ycc131_003_radioDiv")).isDisplayed()) {
        		driver.findElement(By.id("ycc131_003_radioDiv")).click();
        		break;
			}
        	if (driver.findElement(By.id("ycc131_004_radioDiv")).isDisplayed()) {
        		driver.findElement(By.id("ycc131_004_radioDiv")).click();
        		break;
        	}
        	if (driver.findElement(By.id("ycc131_005_radioDiv")).isDisplayed()) {
        		driver.findElement(By.id("ycc131_005_radioDiv")).click();
        		break;
        	}
        	if (driver.findElement(By.id("ycc131_006_radioDiv")).isDisplayed()) {
        		driver.findElement(By.id("ycc131_006_radioDiv")).click();
        		break;
        	}
        	if (driver.findElement(By.id("ycc131_040_radioDiv")).isDisplayed()) {
        		driver.findElement(By.id("ycc131_040_radioDiv")).click();
        		break;
        	}
        	if (driver.findElement(By.id("ycc131_060_radioDiv")).isDisplayed()) {
